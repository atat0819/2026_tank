...
if ($source -notmatch 'ClampJ6248Torque\(left_mixed_torque\)') { throw 'left rear torque must be clamped before FSM limiting' }
if ($source -notmatch 'ClampJ6248Torque\(right_mixed_torque\)') { throw 'right rear torque must be clamped before FSM limiting' }
